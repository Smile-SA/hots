...
rules for the :term:`rac` project. The poor man's quality assurance plan.
...
The "master" branch contains the source trees from which the public releases of the :term:`rac`
...
The "testing" branch contains the "bleeding edge" version of the :term:`rac` software, tests and
documentation.
